                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="leading-relaxed">"The customer service here is top-notch. I had a question about my order, and they responded promptly and resolved my issue with professionalism. Very impressed!"</p>
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Natasha Scudder</h2>
                                <p className="text-gray-500">Loyal Customer</p>
                            </div>
                        </div>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 p-4">
                            <div className="h-full text-center">
                                <img alt="testimonial" className="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="../../../portrait-man-laughing.jpg" />
                                <p className="leading-relaxed">"Amazing selection of products! I found exactly what I was looking for, and the prices were unbeatable. Will definitely be shopping here again!".</p>
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Blank Smith </h2>
                                <p className="text-gray-500">Loyal Customer</p>
                            </div>
                        </div>
                    </div>
